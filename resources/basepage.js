...
function basepage(title, preamble, links) {
    ...
    for (l of [['home', 'https://mwetzel7r.github.io'],['cv', 'https://raw.githubusercontent.com/mw3i/mw3i.github.io/main/.resources/.prerendered/cv.md'],['github','https://github.com/mwetzel7r']].reverse()) {
      lnkref = document.createElement('a')
      lnkref.href = l[1]
      lnk = document.createElement('div')
